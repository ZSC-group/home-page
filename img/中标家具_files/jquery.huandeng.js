(function(a) {
    a.fn.DB_tabMotionBanner = function(b) {
        ...
        return this.each(function() {
            var h = a(this);
            var k = h.find(".flash_pic");
            var r = h.find(".flash_pic li");
            var i = h.find(".flash_nums");
            var m = h.find(".flash_nums li");
            var e = h.find(".flash_bg li");
            var q = h.find(".flash_next");
            var g = h.find(".flash_prev");
            var f = r.length;
            var p = 0;
            var j = 0;
            s();
